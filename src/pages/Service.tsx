  ...
  return (
    <section id="services" className="py-16 bg-gray-100">
      <div className="container px-4 mx-auto text-center">
        <h2 className="mb-8 text-4xl font-bold text-gray-900">Our Services</h2>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {servicesData.map((service, index) => (
            <div
              key={index}
              className="p-6 transition-shadow duration-300 transform bg-white rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 hover:bg-[#f9f9f9]"
            >
              ...
              <h3 className="mb-2 text-2xl font-semibold text-gray-800">{service.title}</h3>
